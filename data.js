...
const MFC_PRODUCTS = [
  ...
  },
  {
    ...
    modalContain: true, // au clic : photo entière visible (barquette complète)
    badge: null,
  },
     ...
     l'affiche seule dans la fenêtre. Prix encore à confirmer pour chacune. */
  {
    ...
    variants: [
      ...
      { id: 'soda-fanta', name: 'Fanta', image: 'images/menu/soda/fanta-25cl.jpg', price: 8, priceLabel: '8 DH' },
      { id: 'soda-sprite', name: 'Sprite', image: 'images/menu/soda/sprite-25cl.jpg', price: 8, priceLabel: '8 DH' },
      { id: 'soda-hawai', name: 'Hawaï Tropical', image: 'images/menu/soda/hawai-25cl.jpg', price: 8, priceLabel: '8 DH' },
    ],
  },
